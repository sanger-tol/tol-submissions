    ...
    def test_submit_manifest_json(self):
        ...
        body = {'samples': [
                    {'row': 1,
                     ...
                     'ORIGINAL_FIELD_COLLECTION_DATE': '2021-05-05',
                     'ORIGINAL_FIELD_COLLECTION_LOCATION': 'United Kingdom | Light Forest',
    ...
    def test_get_manifest(self):
        ...
        expected = {'manifestId': 1,
                    ...
                    'samples': [{
                        ...
                        'ORIGINAL_FIELD_COLLECTION_DATE': None,
                        'ORIGINAL_FIELD_COLLECTION_LOCATION': None,
                        'BARCODE_HUB': None,
                        'tolId': None,
                        'biosampleAccession': None,
                        'sraAccession': None,
